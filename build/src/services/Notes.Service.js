...
class NoteService {
    ...
    createNote(data, owner_id, lead_id) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if ((data === null || data === void 0 ? void 0 : data.tags) && Object.keys(data.tags).length > 0) {
                tags = yield Promise.all(data.tags.map((tag) => __awaiter(this, void 0, void 0, function* () { return yield this.storeNoteTags(note.id, tag.tag_id, tag.entity, tag.entity_id); })));
            }
            return {
                note,
                documents: docs,
    ...
    storeNoteTags(note_id, tag_id, entity, entity_id) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    allNotes(lead_id, search, page, limit, status, from, to) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const [notes, total] = yield new DBAdapter_1.default().findAndCount(Note_entity_1.Note, {
                where: Object.assign(Object.assign(Object.assign({ title: !search ? (0, typeorm_1.Not)((0, typeorm_1.IsNull)()) : (0, typeorm_1.ILike)("%" + search + "%") }, query), { content: !search ? (0, typeorm_1.Not)((0, typeorm_1.IsNull)()) : (0, typeorm_1.ILike)("%" + search + "%") }), query),
                skip,
                take: limit,
                relations: {
                    // lead: true,
    ...
    getOne(lead_id, note_id, user_id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const tags = yield new DBAdapter_1.default().find(NoteTag_entity_1.NoteTag, Object.assign({}, query));
    ...
    updateNote(lead_id, note_id, user_id, updates) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (tags) {
                ...
                newTags = tags.map((tag) => __awaiter(this, void 0, void 0, function* () { return yield this.storeNoteTags(note.id, tag.tag_id, tag.entity, tag.entity_id); }));
            }
            else {
